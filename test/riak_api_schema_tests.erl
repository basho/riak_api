...
basic_schema_test() ->
    ...
    cuttlefish_unit:assert_not_configured(Config, "riak_api.tls"),
...
override_schema_test() ->
    ...
    Conf = [
        ...
        {["listener", "tls", "internal"], "127.0.0.10:4000"},
        {["listener", "tls", "external"], "127.0.0.11:4000"},
    ...
    cuttlefish_unit:assert_config(Config, "riak_api.tls", [{"127.0.0.11", 4000}, {"127.0.0.10", 4000}]),
